...
echoBold "
To access the Status Dashboard of WSO2 Stream Processor, use https://localhost:9643/monitoring.
To access the Editor of WSO2 Stream Processor, use http://localhost:9390/editor.
